...
# get Google and Google Cloud and YouTube list unmerged
name_list1=google
...
name_list3=youtube
curl --max-time 30 --retry-delay 3 --retry 10 -4s -# https://raw.githubusercontent.com/$NAME_ACCOUNT_GITHUB/ipranges/refs/heads/main/$name_list3/ipv4.txt.zst | zstd -d >> ${name_dir}/ipv4.txt
# sorting address
